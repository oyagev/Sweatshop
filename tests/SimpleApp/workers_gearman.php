...
$queue = $sweatshop->addQueue('gearman', array('max_work_cycles' => 3, 'max_memory_per_thread'=> 10000000));
$sweatshop->registerWorker($queue, 'topic:test', 'BackgroundPrintWorker');
